...
def bulk_process_devices(data_root):
    ...
    for thing_name in ts_dirs.keys():
        device_df = load_device_from_clreaml(data_root, thing_name, clearml_url=ts_dirs[thing_name])
...
if __name__ == "__main__":
    ...
    baseload_output = substract_devices_from_total(total_processed, devices_processed, filter_negatives=True)
